...
public class CreaQuizRispostaMultipla extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CreaQuizRispostaMultipla frame = new CreaQuizRispostaMultipla();
	...
	public CreaQuizRispostaMultipla() {
		...
		lblNewLabel.setBounds(38, 44, 49, 14);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("(domanda che decide il prof)");
		lblNewLabel_1.setBounds(335, 118, 49, 14);
		...
		lblNewLabel_2.setBounds(391, 224, 125, 14);
