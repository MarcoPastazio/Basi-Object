...
public class CorrezioneQuiz extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CorrezioneQuiz frame = new CorrezioneQuiz();
	...
	public CorrezioneQuiz() {
		...
		lblNewLabel.setBounds(43, 50, 49, 14);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("(Domanda da correggere)");
		lblNewLabel_1.setBounds(43, 120, 49, 14);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("New label");
		lblNewLabel_2.setBounds(303, 197, 49, 14);
		contentPane.add(lblNewLabel_2);
		
		JButton btnNewButton = new JButton("SBAGLIATA");
		btnNewButton.setBounds(118, 265, 89, 23);
		contentPane.add(btnNewButton);
		
		JButton btnNewButton_2 = new JButton("CORRETTA");
		btnNewButton_2.setBounds(467, 265, 89, 23);
		contentPane.add(btnNewButton_2);
		
		JButton btnNewButton_3 = new JButton("AVANTI");
