	...
	public HomeStudente(JFrame framechiamante, Studente st, Controller r) {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				int contoaperte = r.ConteggioDomande("La Magica Roma");
				int contomultiple = r.ConteggioDomandeM("La Magica Roma");
				JFrame frameDaChiamare = new SceltaTest(frame, r, contoaperte, contomultiple, st);
