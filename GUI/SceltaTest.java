...
public class SceltaTest extends JFrame {
	 ...
	 * Create the frame.
	 */
	public SceltaTest(JFrame framechiamante, Controller r, int contoaperte, int contomultiple, Studente st) {
		frame = this;
		...
		btnNewButton_4.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String[] aperte = new String[contoaperte];
				String[] multiple = new String[contomultiple];
				JFrame frameDaChiamare = new QuizAperte(frame, r, contoaperte, contomultiple, st, aperte, multiple, indice, "La Magica Roma");
